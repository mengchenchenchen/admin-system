...
The third step is to delete the entry. Enter 'src/components/Sidebar.vue' and delete the code below.
...
Finally,enter 'src/components/Sidebar.vue' and find el-menu Tags,delete 'background-color/text-color/active-text-color'。
